...
VL_ATTR_COLD void Vclktick___024root__trace_init_sub__TOP__0(Vclktick___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"lightsequence", false,-1, 7,0);
    ...
    tracep->pushNamePrefix("lightoutput ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"rst", false,-1);
...
VL_ATTR_COLD void Vclktick___024root__trace_full_sub_0(Vclktick___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,(vlSelf->lightsequence),8);
    bufp->fullSData(oldp+7,(vlSelf->clktick__DOT__count),16);
    bufp->fullIData(oldp+8,(vlSelf->clktick__DOT__lightoutput__DOT__current_state),32);
    bufp->fullIData(oldp+9,(vlSelf->clktick__DOT__lightoutput__DOT__next_state),32);
