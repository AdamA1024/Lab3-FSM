...
void Vclktick___024root__trace_chg_sub_0(Vclktick___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+5,(vlSelf->lightsequence),8);
    bufp->chgSData(oldp+6,(vlSelf->clktick__DOT__count),16);
    bufp->chgIData(oldp+7,(vlSelf->clktick__DOT__lightoutput__DOT__current_state),32);
    bufp->chgIData(oldp+8,(vlSelf->clktick__DOT__lightoutput__DOT__next_state),32);
}
